...
namespace Visualization
{
    ...
    {
        public TableResult(ItemSet itemSet, List<AssociationRule> rules)
        {
            InitializeComponent();
            ...
            else
            {
                ...
                {
                    RulesDataGridView.Rows.Add(item.Label, item.Confidence.ToPercentString(), item.Support.ToPercentString());
                }
            }
        }

        public TableResult(List<string> Values)
        {
            InitializeComponent();
